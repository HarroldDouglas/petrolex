...
<head>
    ...
    <title>Account Deletion - Petrolex Delivery App</title>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p class="subtitle">Petrolex Delivery Application</p>
        </div>
        ...
        <div class="content-card">
            <div class="section">
                ...
                <p>
                    The <strong>Petrolex Delivery App</strong>, developed by <strong>Afrik Solutions</strong>,
                    enables you to manage your gas cylinder deliveries efficiently and easily.
                </p>
            </div>
            ...
            <div class="section">
                ...
                <ol class="steps">
                    <li>
                        <strong>Open the Petrolex Delivery App</strong><br>
            ...
            <div class="section">
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><strong>Vehicle Information</strong><br>
                                (License plate, model)
                            </td>
                            <td><span class="badge badge-deleted">✓ Deleted</span></td>
                            <td>Immediate and permanent deletion</td>
                        ...
                        <tr>
                            <td><strong>Delivery History</strong></td>
                        ...
                        <tr>
                            <td><strong>Photos & Documents</strong><br>
                                (License, ID, profile photos)
                            </td>
                            <td><span class="badge badge-deleted">✓ Deleted</span></td>
                            <td>Immediate and permanent deletion</td>
                        </tr>
            ...
            <div class="section">
                ...
                <ul>
                    ...
                    <li><strong>Legal retention (5 years)</strong>: Delivery and transaction data is anonymized and retained to comply with legal accounting and tax obligations.</li>
                    <li><strong>Technical logs (90 days)</strong>: Connection and geolocation logs are automatically deleted after 90 days.</li>
                </ul>

                <div class="alert alert-info">
                    <strong>ℹ️ Why retain some data?</strong><br>
                    The anonymized retention of delivery data is a legal requirement in Cameroon
        ...
        <div class="footer">
            <p>
                <strong>Petrolex - Delivery Application</strong><br>
