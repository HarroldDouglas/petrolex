...
@section('main-content')
    <div class="container-fluid">
        ...
        <div class="row m-1">
            <div class="col-8 p-0">
                <h4 class="main-title">Détail du client</h4>
                <ul class="app-line-breadcrumbs mb-3">
                    <li class="">
                        <a href="{{ route('users.list') }}" class="f-s-14 f-w-500">
                            <span>
                                <i class="ph-duotone ph-stack f-s-16"></i> Clients
                            </span>
                        </a>
                    </li>
                    <li class="active">
                        <a href="#" class="f-s-14 f-w-500">Détails du client </a>
                    </li>
                </ul>
            </div>
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Détails du client (ID: {{ $customer->id }})</h5>
                                </div>
                                <div class="card-body">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    @livewire('user.customer-order-data-table', ['user' => $user])
                                </div>
                            </div>
                        </div>
                        <!-- Customer Orders end -->
