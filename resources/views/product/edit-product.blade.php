        ...
        <div class="row m-1">
            <div class="col-8 p-O ">
                ...
                <ul class="app-line-breadcrumbs mb-3">
                    ...
                    <li class="">
                        <a href="{{ route('products.details', 1) }}" class="f-s-14 f-w-500">Détails du produit</a>
                    </li>
                    <li class="active">
                        ...
                        <form class="row app-form g-3" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="product_name" name="name"
                                    value="Bouteille de gaz 12kg" required>
                            </div>

                            <div class="col-md-12">
                                <label for="description" class="form-label">Description du produit</label>
                                <textarea class="form-control" id="description" name="description" rows="3" required>Bouteille de gaz de 12kg pour usage domestique. Idéale pour la cuisine et le chauffage. Cette bouteille est conforme aux normes de sécurité en vigueur et offre une autonomie prolongée.</textarea>
                            </div>

                            <div class="col-md-12">
                                <label for="product_images" class="form-label">Ajouter de nouvelles images</label>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-3 position-relative">
                                        <div class="card h-100">
                                            <img src="{{ asset('assets/images/team/1.jpg') }}" class="card-img-top"
                                                alt="Product Image">
                                            <button type="button"
                                                class="btn btn-danger btn-sm position-absolute top-0 end-0 m-2 rounded"
                                    ...
                                    <div class="col-md-3 position-relative">
                                        <div class="card h-100">
                                            <img src="{{ asset('assets/images/team/2.jpg') }}" class="card-img-top"
                                                alt="Product Image">
                                            <button type="button"
                                                class="btn btn-danger btn-sm position-absolute top-0 end-0 m-2 rounded"
                                                title="Supprimer cette image">
                                    ...
                                    <div class="col-md-3 position-relative">
                                        <div class="card h-100">
                                            <img src="{{ asset('assets/images/team/3.jpg') }}" class="card-img-top"
                                                alt="Product Image">
                                            <button type="button"
                                                class="btn btn-danger btn-sm position-absolute top-0 end-0 m-2 rounded"
                                                title="Supprimer cette image">
                            ...
                            <div class="col-md-12 mt-4">
                                ...
                                <div id="variations-container">
                                    ...
                                    <div class="row variation-row mb-2">
                                        <div class="col-md-5">
                                            <input type="text" class="form-control" name="variations[1][name]"
                                                value="Bouteille avec gaz" required>
                                        </div>
                                        <div class="col-md-5">
                                            <input type="number" class="form-control" name="variations[1][price]"
                                    ...
                                    <div class="row variation-row mb-2">
                                        <div class="col-md-5">
                                            <input type="text" class="form-control" name="variations[2][name]"
                                                value="Recharge seule" required>
                                        </div>
                                        <div class="col-md-5">
                                            <input type="number" class="form-control" name="variations[2][price]"
                                                value="8000" required>
                                        </div>
                                        <div class="col-md-2">
                                            <button type="button" class="btn btn-danger remove-variation">
...
@section('script')
    <script>
        $(document).ready(function() {
            let variationCount = 3; // Starting with 3 pre-filled variations
