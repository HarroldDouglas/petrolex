...
@section('main-content')
    <div class="container-fluid">
        ...
        <div class="row m-1">
            <div class="col-8 p-0">
                <h4 class="main-title">Liste des quartiers</h4>
                <ul class="app-line-breadcrumbs mb-3">
                    <li class="">
                        <a href="#" class="f-s-14 f-w-500">
                            <span>
                                <i class="ph-duotone ph-map-pin f-s-16"></i> Quartiers
                            </span>
                        </a>
                    </li>
                    <li class="active">
            ...
            <div class="col-4 p-0">
                <div class="d-flex justify-content-end text-success-dark">
                    <a type="button" href="{{ route('neighborhoods.create') }}"
                ...
                <div class="card card-border">
                    <div class="card-body p-0">
                        ...
                        <div class="table-responsive app-scroll app-datatable-default">
                            @livewire('neighborhood.neighborhood-data-table')
                        </div>
                        <!-- table -->
                    </div>
                </div>
