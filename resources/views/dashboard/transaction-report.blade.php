                ...
                <div class="row">
                        ...
                        <div class="card ticket-card bg-light-primary">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start mb-3">
                                    <p class="f-s-16 mb-0">Total des transactions<br>(en {{ \App\Enums\Currency::from(config('countries.default_currency', 'XAF'))->label }})</p>
                    ...
                    <div class="col-lg-3">
                        <div class="card ticket-card bg-light-warning">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start mb-3">
                                    <p class="f-s-16 mb-0">Total des achats<br>(en {{ \App\Enums\Currency::from(config('countries.default_currency', 'XAF'))->label }})</p>
                                    <div class="h-40 w-40 d-flex-center b-r-8 bg-white">
                    ...
                    <div class="col-lg-3">
                        <div class="card ticket-card bg-light-success">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start mb-3">
                                    <p class="f-s-16 mb-0">Total des ventes<br>(en {{ \App\Enums\Currency::from(config('countries.default_currency', 'XAF'))->label }})</p>
                                    <div class="h-40 w-40 d-flex-center b-r-8 bg-white">
                    ...
                    <div class="col-lg-3">
                        <div class="card ticket-card bg-light-danger">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start mb-3">
                                    <p class="f-s-16 mb-0">Autres dépenses<br>(en {{ \App\Enums\Currency::from(config('countries.default_currency', 'XAF'))->label }})</p>
                                    <div class="h-40 w-40 d-flex-center b-r-8 bg-white">
                            ...
                            <table class="w-100 display ticket-app-table" id="ticketdatatable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="w-10">Montant ({{ \App\Enums\Currency::from(config('countries.default_currency', 'XAF'))->label }})</th>
