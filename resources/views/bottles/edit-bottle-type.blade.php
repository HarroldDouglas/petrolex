                        ...
                        <form class="row app-form g-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="type_name" placeholder="Ex: Bouteille 6kg"
                                    value="Bouteille de 25KG" required>
                            </div>
                            <div class="col-md-4">
                                <label for="bottle_price" class="form-label">Prix de la bouteille vide</label>
                                <input type="number" class="form-control" id="bottle_price" value="7000"
                                    placeholder="Ex: 7000" required>
                            </div>
                            <div class="col-md-4">
                                <label for="bottle_capacity_price" class="form-label">Prix de la contenance</label>
                                <input type="number" class="form-control" id="bottle_capacity_price" value="8500"
                                    placeholder="Ex: 8500" required>
                            </div>
                            <div class="col-md-4">
                                <label for="bottle_price" class="form-label">Prix de la bouteille pleine</label>
                                <input type="number" class="form-control" id="bottle_price" value="25000"
                            ...
                            <div class="col-md-8">
                                ...
                                <textarea class="form-control" id="description" rows="3" placeholder="Entrez la description ici" required>Cette bouteille est idéale pour les restaurants.</textarea>
                            </div>
