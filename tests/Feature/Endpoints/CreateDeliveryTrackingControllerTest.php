...
class CreateDeliveryTrackingControllerTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_create_delivery_tracking_requires_authentication(): void
    {
        $response = $this->postJson('/api/tracking/delivery/', [
    ...
    public function test_create_delivery_tracking_creates_new_tracking(): void
    {
        ...
        // Should create new tracking record
        $this->assertDatabaseHas('delivery_trackings', [
            'order_id' => $this->order->id,
        ]);
    }

    public function test_create_delivery_tracking_requires_order_id(): void
    {
        Sanctum::actingAs($this->deliveryPerson);
    ...
    public function test_create_delivery_tracking_fails_for_nonexistent_order(): void
    {
        Sanctum::actingAs($this->deliveryPerson);
