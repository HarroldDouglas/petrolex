...
Je compte sur toi pr agir comme un senior, garde nos standards, code bien propre stp, pas de commentaires en français uniquement en anglais si important, SOLID principles, logique simple et comprehensible, code lisible et optimisé, testable! si tu as besoin de modifier une table, modifie directement la migration car le porjet nest pas encore en production! N'oublie pas de mettre à jour nos fichiers de documentation swagger stp, c'est important pr les devs frontend. Je me dis que pr ne pas trop perdre en contxte, après chaque tache tu peux compacter la conversation et donc le contexte
