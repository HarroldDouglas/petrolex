...
class AccessoryDataTable extends BaseDataTable
{
    ...
    public function filters(): array
    {
        ...
        return [
            ...
            NumberFilter::make('Prix Min ('.Currency::make(config('countries.default_currency', 'XAF'))->label.')')
                ->config([
            ...
            NumberFilter::make('Prix Max ('.Currency::make(config('countries.default_currency', 'XAF'))->label.')')
                ->config([
