...
class OrderResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'status_label' => $this->status->label ?? $this->status->value,
            'delivery_type' => $this->delivery_type->value,
            'delivery_type_label' => $this->delivery_type->label ?? $this->delivery_type->value,
            'payment_method' => $this->payment_method->value ?? null,
            'payment_method_label' => $this->payment_method->label ?? $this->payment_method->value ?? null,
            'subtotal' => $this->subtotal,
            'delivery_fee' => $this->delivery_fee,
            'total_amount' => $this->total_amount,
            'order_date' => $this->order_date ?? $this->created_at?->toISOString(),
            'delivery_date' => $this->delivery_date,
            'invoice_url' => url("/api/orders/{$this->id}/download/invoice"),
