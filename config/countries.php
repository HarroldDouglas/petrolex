...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Default number of decimal places to use for currency formatting
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This array contains all valid ISO country codes that can be used
    | throughout the application for country validation.
    |
    */
